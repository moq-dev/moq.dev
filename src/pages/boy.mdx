...
- 🔍 **Discoverable**: The CDN announces which games are available _and_ who wants to play. There's no custom orchistration layer; all clients connect to `cdn.moq.dev` **ONLY**.
