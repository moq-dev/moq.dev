...
## moq-dev org
But first, some arbitrary renaming:

Given this is a community effort now, it's time to move the repos to a new [moq-dev](https://github.com/moq-dev) organization.
No more typing `kixelated` over and over again!

And somehow the `@moq` NPM organization was available, so now you can: `npm install @moq/hang`
