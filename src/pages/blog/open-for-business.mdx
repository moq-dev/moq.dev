...
The entire point of a **standard** is so you can switch out cloud providers without eating dirt.
And the entire point of **open-source** is so cloud providers can sell something they didn't make.
...
Of course there are libraries for [Rust](https://doc.moq.dev/lib/rs/) (native) and [Typescript](https://doc.moq.dev/lib/js/) (web).
...
Many of these are written by Mr. Claude.
I'm a fraud, I know, I don't actually know Kotlin/Swift and most definitely don't want to work on the SRT integration.
Yell if you run into issues and better yet, point Mr. Claude towards the [repo](https://github.com/moq-dev/moq) to
donate some tokens.
