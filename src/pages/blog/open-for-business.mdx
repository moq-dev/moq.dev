...
If you're using a cloud WebRTC provider, convice your CFO to let you prototype MoQ for that sweet capex savings.
...
You can switch out the `https://cdn.moq.pro` URL with a different CDN provideex and *should* just work™.
