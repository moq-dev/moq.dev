...
[moq-relay](https://doc.moq.dev/app/relay/) is the champ that them into a single *upstream* `SUBSCRIBE 1080p`.
...
It's the exact same concept at HTTP CDNs, but for live streams.
