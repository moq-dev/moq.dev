...
I'm biased so naturally I'm going to use my [@moq](https://github.com/moq-dev/moq/tree/main/js) packages (smash that star button).
...
```html
<script type="module">
	// Registers the <moq-publish> and <moq-publish-ui> elements.
	import "@moq/publish/element";
	import "@moq/publish/ui";
</script>

<!-- You'll need to replace `path` with something unique/random. -->
<moq-publish-ui>
	<moq-publish url="https://relay.cloudflare.mediaoverquic.com" path="unique-name-abc123" source="camera">
...
```html
<script type="module">
	// Registers the <moq-watch> and <moq-watch-ui> elements.
	import "@moq/watch/element";
	import "@moq/watch/ui";
</script>

<!-- Use the same path as the broadcast you published. -->
<moq-watch-ui>
	<moq-watch url="https://relay.cloudflare.mediaoverquic.com" path="unique-name-abc123" muted>
...
You might even notice **closed captions** because I've been experimenting with AI features (gotta get funding eventually 💰).
...
Tweaking the encoding for the hundredth time can wait for another day.
