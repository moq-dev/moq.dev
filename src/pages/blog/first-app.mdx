...
[4 months ago](/blog/application-first) I quit my job and went all-in on MoQ.
...
If any of those names sound cool, check out my [Replacing WebRTC](/blog/replacing-webrtc) post.
And maybe you can catch me in [hang.live/@moq](https://hang.live/@moq) when the kids aren't hovering around my office.
...
Just like the [Cloudflare CDN](/blog/first-cdn), consider this as a starting point and NOT the end state.
