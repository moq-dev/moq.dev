...
I eventually stumbled upon QUIC/WebTransport and [pivoted once more](https://moq.dev/blog/distribution-at-twitch).
...
But hey, I got severance and used it to build this crude [moq.dev](https://moq.dev) website while in a coffee shop in Tokyo.
...
However.
HOWEVER.
[I decided this was not the most productive path](https://moq.dev/blog/transfork).
...
This demo currently uses [Rust+WASM](https://moq.dev/blog/to-wasm) but it's time to hit the revert button.
Oops.
