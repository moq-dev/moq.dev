...
<ul class="list-none pl-0">
	...
	<Feature icon="scale">**Massive Scale**: Host your own CDN with [moq-relay](https://github.com/moq-dev/moq/tree/main/rs/moq-relay) or use [Cloudflare](/blog/first-cdn).</Feature>
	...
	<Feature icon="discover">**Discoverable**: Live notifications when broadcasts are published or finish.</Feature>
	<Feature icon="efficient">**Efficient**: No encoding or bandwidth usage until a viewer needs it.</Feature>
	<Feature icon="compatible">**Compatible**: TCP fallback via [WebSocket](https://github.com/moq-dev/web-transport/tree/main/web-transport-ws), Safari fallback via [libav.js](https://github.com/Yahweasel/libav.js/).</Feature>
	<Feature icon="customize">**Customizable**: Hardware accelerated encoding, the rest is in your control.</Feature>
</ul>
