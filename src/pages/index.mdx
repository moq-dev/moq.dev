...
### *Standards
This website uses a [fork](/blog/transfork) of the IETF draft called [moq-lite](https://moq-dev.github.io/drafts/draft-lcurley-moq-lite.html) and a media layer called [hang](https://moq-dev.github.io/drafts/draft-lcurley-moq-hang.html).
